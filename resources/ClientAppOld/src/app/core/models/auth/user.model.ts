...
export interface IOrganization { id: string, name: string }
export class Organization { id = new FormControl(null); name = new FormControl(null); }

export interface IPosition { id: string, name: string }
export class Position { id = new FormControl(null); name = new FormControl(null); }
