...
export class ProjectDetail {
  ...
  responsibleStudents = new FormArray([new FormGroup(new ResponsibleStudent())]);
  projectAdvisors = new FormArray([new FormGroup(new ProjectAdvisor())])
...
export class CongruenceIdentity {
  id = new FormControl(null)
  projectDetailId = new FormControl(null)
  groups = new FormArray([new FormControl(null)])
  details = new FormArray([new FormControl(null)])
}

export class ProjectParticipant {
  id = new FormControl(null)
  projectDetailId = new FormControl(null)
  advisor = new FormArray([new FormControl(null)])
  student = new FormArray([new FormControl(null)])
  teacher = new FormArray([new FormControl(null)])
