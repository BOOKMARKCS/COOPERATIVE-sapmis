import {Component, EventEmitter, OnInit, Output, input, Input, signal} from '@angular/core';
...
export class ButtonComponent implements OnInit {
  @Input() buttonType: ButtonProps['buttonType'] = 'submit';
  ...
  impactClasses: Record<ButtonProps['tone'], Record<ButtonProps['impact'], string>> = {
    ...
    card: {
      bold: 'bg-card text-muted-foreground shadow-md hover:bg-muted hover:text-foreground focus-visible:ring-card',
      light: 'bg-card/20 text-muted-foreground hover:bg-muted hover:text-foreground focus-visible:ring-card',
      none: 'bg-transparent text-muted-foreground hover:bg-muted hover:text-foreground focus-visible:ring-card',
    },
    danger: {
